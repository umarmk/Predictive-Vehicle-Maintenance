    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      ...
      <div className="w-64 bg-white dark:bg-gray-800 shadow-md fixed h-full">
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white">RideAhead</h2>
        </div>
        <nav className="mt-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              {user && (
                <button
                  ...
                  className="p-2 rounded-md bg-red-100 dark:bg-red-900 text-red-600 dark:text-red-400 hover:bg-red-200 dark:hover:bg-red-800 transition-colors"
                  title="Sign out"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
